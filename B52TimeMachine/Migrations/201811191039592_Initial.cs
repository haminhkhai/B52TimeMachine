namespace B52TimeMachine.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        To = c.DateTime(),
                        RentalFee = c.Int(nullable: false),
                        ServiceFee = c.Int(nullable: false),
                        Ps_PsId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RentalId)
                .ForeignKey("dbo.Ps", t => t.Ps_PsId, cascadeDelete: true)
                .Index(t => t.Ps_PsId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Rentals", "Ps_PsId", "dbo.Ps");
            ...
            DropIndex("dbo.Rentals", new[] { "Ps_PsId" });
